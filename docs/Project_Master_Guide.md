> # ⚠️ SUPERSEDED — DO NOT CITE THE RESULTS IN THIS DOCUMENT
>
> Written 2026-07-14 on the **300-document** corpus. Scaling to 994 documents
> and running the full control set **reversed two of its central claims**:
>
> - This guide says document-level reasoning fusion is a **null**. It is not —
>   at 994 documents the same comparison is **+0.0257, p = 1.2e-04**.
> - This guide says **field-localized attribution** is what makes the reasoning
>   signal work. It is not — the document mean of the same vectors performs
>   identically (**Δ = −0.0036, p = 0.71**).
>
> The pipeline description, dataset explanation and worked example remain
> accurate. **The results, the Q&A bank and the "three-act" framing do not.**
>
> Current versions: **[`Update_08.md`](Update_08.md)** for results and the
> leakage audit, **[`Meeting_Briefing_2026-08-25.md`](Meeting_Briefing_2026-08-25.md)**
> for the ground-up explanation and up-to-date Q&A bank.
