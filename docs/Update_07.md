> ⚠️ **SUPERSEDED.** This update's headline — that **field-localized**
> attribution is what makes the reasoning signal work — did not survive scaling
> and controls. The effect is real and now far stronger (**+0.0364,
> p = 1.7e-05**), but it is **document-level**: the document mean of the same
> vectors performs identically (Δ = −0.0036, p = 0.71), and pooling the whole
> trace performs identically to pooling value-mention tokens (p = 0.96).
> See [`Update_08.md`](Update_08.md) §6.
