> ⚠️ **SUPERSEDED in one respect.** §6.3 reports document-level reasoning fusion
> as a clean null. That null was a **power artifact** at 300 documents — its
> point estimates were positive throughout (+0.003 to +0.013), and at 994
> documents the same comparison is **+0.0257, p = 1.2e-04**. Do not cite it as a
> negative result. See [`Update_08.md`](Update_08.md) §6(c).
